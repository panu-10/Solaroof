...
const url = state === "Employee Login" ? `${process.env.REACT_APP_HIT_URL}/login` : `${process.env.REACT_APP_HIT_URL}/signup`;

// Validate email domain for sign-up
if (state === "Employee Signup" && !formData.email.endsWith('@tatapower.com')) {
...
if (dataObj.success) {
  ...
  window.location.replace("/dash"); // Redirect to home page
} else {
